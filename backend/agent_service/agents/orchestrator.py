...
class OrchestratorAgent:
    ...
    def __init__(self):
        """Initializes all specialist agents. They will inherit the LLM from BaseAgent."""
        self.text_agent = TextAnalysisAgent()
        self.image_agent = ImageAnalysisAgent()
        self.comp_agent = CompAnalysisAgent()
        self.financial_agent = FinancialAnalysisAgent()
        self.contractor_agent = ContractorSearchAgent()
    ...
    async def generate_full_report(self, property_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        print("--- generate_full_report started with Gemini agent team ---")
        ...
        try:
            ...
            if not comparable_properties:
                print("[Orchestrator] Comp search Attempt 1 FAILED. Attempt 2: Expanding search...")
            ...
            print(f"[Orchestrator] Calling ContractorSearchAgent for: {top_idea_name}")
            ...
            final_report = {
                ...
                "market_summary": writer_result.get("market_summary"),
                "investment_thesis": writer_result.get("investment_thesis"),
                "error": None
            }
